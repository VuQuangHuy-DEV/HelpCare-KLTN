...
export default function BlogPostCard({ post, index }) {
  ...
  const { id, tieu_de, ngay_khoi_tao, chi_tiet, location, khach_hang, price } = post;
  ...
  if (isDesktop && latestPost) {
    return (
      <Card>
        <Avatar
          alt={khach_hang}
          src={"https://pbs.twimg.com/media/DNUBk22W0AA1jIK.jpg"}
          sx={{
            top: 24,
            left: 24,
            zIndex: 9,
        ...
        <PostContent
          ...
          comment={200}
          share={300}
          createdAt={ngay_khoi_tao}
          index={index}
        />

        <StyledOverlay />

        <Image alt="cover" src={"https://storage.timviec365.vn/timviec365/pictures/images/cover-la-gi.png"} sx={{ height: 360 }} />
      </Card>
    );
  }
  ...
  return (
    <Card>
      <Box sx={{ position: 'relative' }}>
        ...
        <Image alt="cover" src={"https://storage.timviec365.vn/timviec365/pictures/images/cover-la-gi.png"} ratio="4/3" />
      </Box>
