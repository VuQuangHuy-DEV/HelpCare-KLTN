...
const API_DICHVU_ADD = API_ROOT + "transaction/giaodich/"
...
export default function GiaoDich({ route }) {
          ...
          >
            <TouchableOpacity
              style={{
                ...
                flexDirection: "row",
                alignItems: "center",
                backgroundColor: selectedButton === "Thu" ? "green" : "white",
              }}
            ...
            <TouchableOpacity
              style={{
                ...
                alignItems: "center",
                backgroundColor:
                  selectedButton === "Chuyen" ? "green" : "white",
              }}
